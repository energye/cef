...
func NewV8Handler() IV8Handler {
	r1 := v8HandlerImportAPI().SysCallN(0)
...
func (m *TV8Handler) SetOnExecute(fn TOnV8HandlerExecute) {
	...
	v8HandlerImportAPI().SysCallN(1, m.Instance(), m.executePtr)
}

var (
	v8HandlerImport       *imports.Imports = nil
	v8HandlerImportTables                  = []*imports.Table{
		/*0*/ imports.NewTable("V8Handler_Create", 0),
		/*1*/ imports.NewTable("V8Handler_SetOnExecute", 0),
	}
)
