...
func (m *TChromiumCore) AcceptLanguageList() (result string) {
	...
	strBuf := api.NewStringBuffer(0, 0)
	chromiumCoreAPI().SysCallN(205, 0, m.Instance(), 0, uintptr(base.UnsafePointer(&strBuf.Data)), uintptr(base.UnsafePointer(&strBuf.Size)))
	defer strBuf.Release()
	result = strBuf.String()
	return
}
...
func (m *TChromiumCore) HSTSPolicyBypassList() (result string) {
	...
	strBuf := api.NewStringBuffer(0, 0)
	chromiumCoreAPI().SysCallN(233, 0, m.Instance(), 0, uintptr(base.UnsafePointer(&strBuf.Data)), uintptr(base.UnsafePointer(&strBuf.Size)))
	defer strBuf.Release()
	result = strBuf.String()
	return
}
