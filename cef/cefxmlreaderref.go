...
func (m *TCefXmlReaderRef) GetError() string {
	if !m.IsValid() {
		return ""
	}
	r := cefXmlReaderRefAPI().SysCallN(4, m.Instance())
	return api.GoStr(r)
}
...
func (m *TCefXmlReaderRef) GetLocalName() string {
	if !m.IsValid() {
		return ""
	}
	r := cefXmlReaderRefAPI().SysCallN(7, m.Instance())
	return api.GoStr(r)
}

func (m *TCefXmlReaderRef) GetPrefix() string {
	if !m.IsValid() {
		return ""
	}
	r := cefXmlReaderRefAPI().SysCallN(8, m.Instance())
	return api.GoStr(r)
}

func (m *TCefXmlReaderRef) GetQualifiedName() string {
	if !m.IsValid() {
		return ""
	}
	r := cefXmlReaderRefAPI().SysCallN(9, m.Instance())
	return api.GoStr(r)
}

func (m *TCefXmlReaderRef) GetNamespaceUri() string {
	if !m.IsValid() {
		return ""
	}
	r := cefXmlReaderRefAPI().SysCallN(10, m.Instance())
	return api.GoStr(r)
}

func (m *TCefXmlReaderRef) GetBaseUri() string {
	if !m.IsValid() {
		return ""
	}
	r := cefXmlReaderRefAPI().SysCallN(11, m.Instance())
	return api.GoStr(r)
}

func (m *TCefXmlReaderRef) GetXmlLang() string {
	if !m.IsValid() {
		return ""
	}
	r := cefXmlReaderRefAPI().SysCallN(12, m.Instance())
	return api.GoStr(r)
}
...
func (m *TCefXmlReaderRef) GetValue() string {
	if !m.IsValid() {
		return ""
	}
	r := cefXmlReaderRefAPI().SysCallN(15, m.Instance())
	return api.GoStr(r)
}
...
func (m *TCefXmlReaderRef) GetAttributeByIndex(index int32) string {
	if !m.IsValid() {
		return ""
	}
	r := cefXmlReaderRefAPI().SysCallN(18, m.Instance(), uintptr(index))
	return api.GoStr(r)
}

func (m *TCefXmlReaderRef) GetAttributeByQName(qualifiedName string) string {
	if !m.IsValid() {
		return ""
	}
	r := cefXmlReaderRefAPI().SysCallN(19, m.Instance(), api.PasStr(qualifiedName))
	return api.GoStr(r)
}

func (m *TCefXmlReaderRef) GetAttributeByLName(localName string, namespaceURI string) string {
	if !m.IsValid() {
		return ""
	}
	r := cefXmlReaderRefAPI().SysCallN(20, m.Instance(), api.PasStr(localName), api.PasStr(namespaceURI))
	return api.GoStr(r)
}

func (m *TCefXmlReaderRef) GetInnerXml() string {
	if !m.IsValid() {
		return ""
	}
	r := cefXmlReaderRefAPI().SysCallN(21, m.Instance())
	return api.GoStr(r)
}

func (m *TCefXmlReaderRef) GetOuterXml() string {
	if !m.IsValid() {
		return ""
	}
	r := cefXmlReaderRefAPI().SysCallN(22, m.Instance())
	return api.GoStr(r)
}
