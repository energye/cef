...
func (m *TCefRequestRef) GetUrl() (result string) {
	...
	cefRequestRefAPI().SysCallN(2, m.Instance(), sw.Instance())
	result = sw.Value()
	sw.Free()
	return
}
...
func (m *TCefRequestRef) GetMethod() (result string) {
	...
	sw := lcl.NewStringWrap()
	cefRequestRefAPI().SysCallN(3, m.Instance(), sw.Instance())
	result = sw.Value()
	sw.Free()
	return
}
...
func (m *TCefRequestRef) GetReferrerUrl() (result string) {
	...
	sw := lcl.NewStringWrap()
	cefRequestRefAPI().SysCallN(5, m.Instance(), sw.Instance())
	result = sw.Value()
	sw.Free()
	return
}
...
func (m *TCefRequestRef) GetHeaderByName(name string) (result string) {
	...
	sw := lcl.NewStringWrap()
	cefRequestRefAPI().SysCallN(7, m.Instance(), api.PasStr(name), sw.Instance())
	result = sw.Value()
	sw.Free()
	return
}
...
func (m *TCefRequestRef) GetFirstPartyForCookies() (result string) {
	...
	sw := lcl.NewStringWrap()
	cefRequestRefAPI().SysCallN(9, m.Instance(), sw.Instance())
	result = sw.Value()
	sw.Free()
	return
}
