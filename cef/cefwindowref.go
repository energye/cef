...
type ICefWindow interface {
	...
	GetFocusedView() ICefView // function
	// GetTitle
...
func (m *TCefWindowRef) GetFocusedView() (result ICefView) {
	if !m.IsValid() {
		return
	}
	var resultPtr uintptr
	cefWindowRefAPI().SysCallN(7, m.Instance(), uintptr(base.UnsafePointer(&resultPtr)))
...
func (m *TCefWindowRef) GetTitle() (result string) {
	...
	cefWindowRefAPI().SysCallN(8, m.Instance(), uintptr(base.UnsafePointer(&strBuf.Data)), uintptr(base.UnsafePointer(&strBuf.Size)))
...
func (m *TCefWindowRef) GetWindowAppIcon() (result ICefImage) {
	...
	var resultPtr uintptr
	cefWindowRefAPI().SysCallN(10, m.Instance(), uintptr(base.UnsafePointer(&resultPtr)))
	result = AsCefImageRef(resultPtr)
	return
}
...
func (m *TCefWindowRef) AddOverlayView(view ICefView, dockingMode cefTypes.TCefDockingMode, canActivate bool) (result ICefOverlayController) {
	...
	var resultPtr uintptr
	cefWindowRefAPI().SysCallN(11, m.Instance(), base.GetObjectUintptr(view), uintptr(dockingMode), api.PasBool(canActivate), uintptr(base.UnsafePointer(&resultPtr)))
...
func (m *TCefWindowRef) GetDisplay() (result ICefDisplay) {
	...
	var resultPtr uintptr
	cefWindowRefAPI().SysCallN(12, m.Instance(), uintptr(base.UnsafePointer(&resultPtr)))
...
func (m *TCefWindowRef) GetClientAreaBoundsInScreen() (result TCefRect) {
	...
	cefWindowRefAPI().SysCallN(13, m.Instance(), uintptr(base.UnsafePointer(&result)))
	return
}
...
func (m *TCefWindowRef) GetRuntimeStyle() cefTypes.TCefRuntimeStyle {
	...
	r := cefWindowRefAPI().SysCallN(15, m.Instance())
...
func (m *TCefWindowRef) Show() {
	...
	cefWindowRefAPI().SysCallN(18, m.Instance())
}
...
func (m *TCefWindowRef) ShowAsBrowserModalDialog(browserView ICefBrowserView) {
	...
	cefWindowRefAPI().SysCallN(19, m.Instance(), base.GetObjectUintptr(browserView))
}
...
func (m *TCefWindowRef) CenterWindow(size TCefSize) {
	...
	cefWindowRefAPI().SysCallN(21, m.Instance(), uintptr(base.UnsafePointer(&size)))
}
...
func (m *TCefWindowRef) SetAlwaysOnTop(onTop bool) {
	...
	cefWindowRefAPI().SysCallN(26, m.Instance(), api.PasBool(onTop))
}
...
func (m *TCefWindowRef) Restore() {
	...
	cefWindowRefAPI().SysCallN(29, m.Instance())
}
...
func (m *TCefWindowRef) SetFullscreen(fullscreen bool) {
	...
	cefWindowRefAPI().SysCallN(30, m.Instance(), api.PasBool(fullscreen))
}
...
func (m *TCefWindowRef) SetTitle(title string) {
	...
	cefWindowRefAPI().SysCallN(31, m.Instance(), api.PasStr(title))
}
...
func (m *TCefWindowRef) SetWindowAppIcon(image ICefImage) {
	...
	cefWindowRefAPI().SysCallN(33, m.Instance(), base.GetObjectUintptr(image))
}
...
func (m *TCefWindowRef) ShowMenu(menuModel ICefMenuModel, screenPoint TCefPoint, anchorPosition cefTypes.TCefMenuAnchorPosition) {
	...
	cefWindowRefAPI().SysCallN(34, m.Instance(), base.GetObjectUintptr(menuModel), uintptr(base.UnsafePointer(&screenPoint)), uintptr(anchorPosition))
}
...
func (m *TCefWindowRef) CancelMenu() {
	...
	cefWindowRefAPI().SysCallN(35, m.Instance())
}
...
func (m *TCefWindowRef) SetDraggableRegions(regionsCount cefTypes.NativeUInt, regions ICefDraggableRegionArray) {
	...
	cefWindowRefAPI().SysCallN(36, m.Instance(), uintptr(regionsCount), regions.Instance())
}
...
func (m *TCefWindowRef) SendKeyPress(keyCode int32, eventFlags uint32) {
	...
	cefWindowRefAPI().SysCallN(37, m.Instance(), uintptr(keyCode), uintptr(eventFlags))
}
...
func (m *TCefWindowRef) SendMouseMove(screenX int32, screenY int32) {
	...
	cefWindowRefAPI().SysCallN(38, m.Instance(), uintptr(screenX), uintptr(screenY))
}
...
func (m *TCefWindowRef) SendMouseEvents(button cefTypes.TCefMouseButtonType, mouseDown bool, mouseUp bool) {
	...
	cefWindowRefAPI().SysCallN(39, m.Instance(), uintptr(button), api.PasBool(mouseDown), api.PasBool(mouseUp))
}
...
func (m *TCefWindowRef) SetAccelerator(commandId int32, keyCode int32, shiftPressed bool, ctrlPressed bool, altPressed bool, highPriority bool) {
	...
	cefWindowRefAPI().SysCallN(40, m.Instance(), uintptr(commandId), uintptr(keyCode), api.PasBool(shiftPressed), api.PasBool(ctrlPressed), api.PasBool(altPressed), api.PasBool(highPriority))
}
...
func (m *TCefWindowRef) RemoveAccelerator(commandId int32) {
	...
	cefWindowRefAPI().SysCallN(41, m.Instance(), uintptr(commandId))
}
...
func (m *TCefWindowRef) RemoveAllAccelerators() {
	...
	cefWindowRefAPI().SysCallN(42, m.Instance())
}
...
func (m *TCefWindowRef) SetThemeColor(colorId int32, color cefTypes.TCefColor) {
	...
	cefWindowRefAPI().SysCallN(43, m.Instance(), uintptr(colorId), uintptr(color))
}
...
func (m *TCefWindowRef) ThemeChanged() {
	...
	cefWindowRefAPI().SysCallN(44, m.Instance())
}
...
func (_WindowRefClass) UnWrapWithPointer(data uintptr) (result ICefWindow) {
	var resultPtr uintptr
	cefWindowRefAPI().SysCallN(16, uintptr(data), uintptr(base.UnsafePointer(&resultPtr)))
...
func (_WindowRefClass) CreateTopLevel(delegate IEngWindowDelegate) (result ICefWindow) {
	var resultPtr uintptr
	cefWindowRefAPI().SysCallN(17, base.GetObjectUintptr(delegate), uintptr(base.UnsafePointer(&resultPtr)))
	result = AsCefWindowRef(resultPtr)
	return
}
...
func cefWindowRefAPI() *imports.Imports {
	cefWindowRefOnce.Do(func() {
		...
		cefWindowRefImport.Table = []*imports.Table{
			...
			/* 7 */ imports.NewTable("TCefWindowRef_GetFocusedView", 0), // function GetFocusedView
			/* 8 */ imports.NewTable("TCefWindowRef_GetTitle", 0), // function GetTitle
			/* 9 */ imports.NewTable("TCefWindowRef_GetWindowIcon", 0), // function GetWindowIcon
			/* 10 */ imports.NewTable("TCefWindowRef_GetWindowAppIcon", 0), // function GetWindowAppIcon
			/* 11 */ imports.NewTable("TCefWindowRef_AddOverlayView", 0), // function AddOverlayView
			/* 12 */ imports.NewTable("TCefWindowRef_GetDisplay", 0), // function GetDisplay
			/* 13 */ imports.NewTable("TCefWindowRef_GetClientAreaBoundsInScreen", 0), // function GetClientAreaBoundsInScreen
			/* 14 */ imports.NewTable("TCefWindowRef_GetWindowHandle", 0), // function GetWindowHandle
			/* 15 */ imports.NewTable("TCefWindowRef_GetRuntimeStyle", 0), // function GetRuntimeStyle
			/* 16 */ imports.NewTable("TCefWindowRef_UnWrapWithPointer", 0), // static function UnWrapWithPointer
			/* 17 */ imports.NewTable("TCefWindowRef_CreateTopLevel", 0), // static function CreateTopLevel
			/* 18 */ imports.NewTable("TCefWindowRef_Show", 0), // procedure Show
			/* 19 */ imports.NewTable("TCefWindowRef_ShowAsBrowserModalDialog", 0), // procedure ShowAsBrowserModalDialog
			/* 20 */ imports.NewTable("TCefWindowRef_Hide", 0), // procedure Hide
			/* 21 */ imports.NewTable("TCefWindowRef_CenterWindow", 0), // procedure CenterWindow
			/* 22 */ imports.NewTable("TCefWindowRef_Close", 0), // procedure Close
			/* 23 */ imports.NewTable("TCefWindowRef_Activate", 0), // procedure Activate
			/* 24 */ imports.NewTable("TCefWindowRef_Deactivate", 0), // procedure Deactivate
			/* 25 */ imports.NewTable("TCefWindowRef_BringToTop", 0), // procedure BringToTop
			/* 26 */ imports.NewTable("TCefWindowRef_SetAlwaysOnTop", 0), // procedure SetAlwaysOnTop
			/* 27 */ imports.NewTable("TCefWindowRef_Maximize", 0), // procedure Maximize
			/* 28 */ imports.NewTable("TCefWindowRef_Minimize", 0), // procedure Minimize
			/* 29 */ imports.NewTable("TCefWindowRef_Restore", 0), // procedure Restore
			/* 30 */ imports.NewTable("TCefWindowRef_SetFullscreen", 0), // procedure SetFullscreen
			/* 31 */ imports.NewTable("TCefWindowRef_SetTitle", 0), // procedure SetTitle
			/* 32 */ imports.NewTable("TCefWindowRef_SetWindowIcon", 0), // procedure SetWindowIcon
			/* 33 */ imports.NewTable("TCefWindowRef_SetWindowAppIcon", 0), // procedure SetWindowAppIcon
			/* 34 */ imports.NewTable("TCefWindowRef_ShowMenu", 0), // procedure ShowMenu
			/* 35 */ imports.NewTable("TCefWindowRef_CancelMenu", 0), // procedure CancelMenu
			/* 36 */ imports.NewTable("TCefWindowRef_SetDraggableRegions", 0), // procedure SetDraggableRegions
			/* 37 */ imports.NewTable("TCefWindowRef_SendKeyPress", 0), // procedure SendKeyPress
			/* 38 */ imports.NewTable("TCefWindowRef_SendMouseMove", 0), // procedure SendMouseMove
			/* 39 */ imports.NewTable("TCefWindowRef_SendMouseEvents", 0), // procedure SendMouseEvents
			/* 40 */ imports.NewTable("TCefWindowRef_SetAccelerator", 0), // procedure SetAccelerator
			/* 41 */ imports.NewTable("TCefWindowRef_RemoveAccelerator", 0), // procedure RemoveAccelerator
			/* 42 */ imports.NewTable("TCefWindowRef_RemoveAllAccelerators", 0), // procedure RemoveAllAccelerators
			/* 43 */ imports.NewTable("TCefWindowRef_SetThemeColor", 0), // procedure SetThemeColor
			/* 44 */ imports.NewTable("TCefWindowRef_ThemeChanged", 0), // procedure ThemeChanged
		}
	})
