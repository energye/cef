...
func resourceHandlerImportAPI() *imports.Imports {
	if resourceHandlerImport == nil {
		resourceHandlerImport = NewDefaultImports()
		resourceHandlerImport.SetImportTable(resourceHandlerImportTables)
		resourceHandlerImportTables = nil
	}
	return resourceHandlerImport
}
