...
func (m *TCefDomDocumentRef) GetTitle() string {
	if !m.IsValid() {
		return ""
	}
	r := cefDomDocumentRefAPI().SysCallN(5, m.Instance())
	return api.GoStr(r)
}
...
func (m *TCefDomDocumentRef) GetSelectionAsMarkup() string {
	if !m.IsValid() {
		return ""
	}
	r := cefDomDocumentRefAPI().SysCallN(11, m.Instance())
	return api.GoStr(r)
}

func (m *TCefDomDocumentRef) GetSelectionAsText() string {
	if !m.IsValid() {
		return ""
	}
	r := cefDomDocumentRefAPI().SysCallN(12, m.Instance())
	return api.GoStr(r)
}

func (m *TCefDomDocumentRef) GetBaseUrl() string {
	if !m.IsValid() {
		return ""
	}
	r := cefDomDocumentRefAPI().SysCallN(13, m.Instance())
	return api.GoStr(r)
}

func (m *TCefDomDocumentRef) GetCompleteUrl(partialURL string) string {
	if !m.IsValid() {
		return ""
	}
	r := cefDomDocumentRefAPI().SysCallN(14, m.Instance(), api.PasStr(partialURL))
	return api.GoStr(r)
}
