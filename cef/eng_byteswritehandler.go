...
func NewCefBytesWriteHandler(aGrow NativeUInt) ICefBytesWriteHandler {
	r1 := bytesWriteHandlerImportAPI().SysCallN(0, uintptr(aGrow))
	return AsCefBytesWriteHandler(r1)
}

func (m *TCefBytesWriteHandler) Write(ptr uintptr, size, n NativeUInt) NativeUInt {
	r1 := bytesWriteHandlerImportAPI().SysCallN(7, m.Instance(), uintptr(ptr), uintptr(size), uintptr(n))
	return NativeUInt(r1)
}

func (m *TCefBytesWriteHandler) Seek(offset int64, whence int32) int32 {
	r1 := bytesWriteHandlerImportAPI().SysCallN(5, m.Instance(), uintptr(unsafePointer(&offset)), uintptr(whence))
	return int32(r1)
}

func (m *TCefBytesWriteHandler) Tell() (resultInt64 int64) {
	bytesWriteHandlerImportAPI().SysCallN(6, m.Instance(), uintptr(unsafePointer(&resultInt64)))
	return
}

func (m *TCefBytesWriteHandler) Flush() int32 {
	r1 := bytesWriteHandlerImportAPI().SysCallN(1, m.Instance())
	return int32(r1)
}

func (m *TCefBytesWriteHandler) MayBlock() bool {
	r1 := bytesWriteHandlerImportAPI().SysCallN(4, m.Instance())
	return GoBool(r1)
}
...
func (m *TCefBytesWriteHandler) GetDataSize() (resultInt64 int64) {
	bytesWriteHandlerImportAPI().SysCallN(3, m.Instance(), uintptr(unsafePointer(&resultInt64)))
	return
}
...
var (
	...
	bytesWriteHandlerImportTables                  = []*imports.Table{
		/*0*/ imports.NewTable("CefBytesWriteHandler_Create", 0),
		/*1*/ imports.NewTable("CefBytesWriteHandler_Flush", 0),
		/*2*/ imports.NewTable("CefBytesWriteHandler_GetData", 0),
		/*3*/ imports.NewTable("CefBytesWriteHandler_GetDataSize", 0),
		/*4*/ imports.NewTable("CefBytesWriteHandler_MayBlock", 0),
		/*5*/ imports.NewTable("CefBytesWriteHandler_Seek", 0),
		/*6*/ imports.NewTable("CefBytesWriteHandler_Tell", 0),
		/*7*/ imports.NewTable("CefBytesWriteHandler_Write", 0),
	}
)
