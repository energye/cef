...
func (m *TCEFFileDialogInfo) Title() string {
	...
	r := cEFFileDialogInfoAPI().SysCallN(3, 0, m.Instance())
	return api.GoStr(r)
}
...
func (m *TCEFFileDialogInfo) DefaultFilePath() string {
	...
	r := cEFFileDialogInfoAPI().SysCallN(4, 0, m.Instance())
	return api.GoStr(r)
}
...
func (m *TCEFFileDialogInfo) DialogFilter() string {
	...
	r := cEFFileDialogInfoAPI().SysCallN(9, m.Instance())
	return api.GoStr(r)
}
...
func (m *TCEFFileDialogInfo) DefaultAudioFileDesc() string {
	...
	r := cEFFileDialogInfoAPI().SysCallN(11, 0, m.Instance())
	return api.GoStr(r)
}
...
func (m *TCEFFileDialogInfo) DefaultVideoFileDesc() string {
	...
	r := cEFFileDialogInfoAPI().SysCallN(12, 0, m.Instance())
	return api.GoStr(r)
}
...
func (m *TCEFFileDialogInfo) DefaultTextFileDesc() string {
	...
	r := cEFFileDialogInfoAPI().SysCallN(13, 0, m.Instance())
	return api.GoStr(r)
}
...
func (m *TCEFFileDialogInfo) DefaultImageFileDesc() string {
	...
	r := cEFFileDialogInfoAPI().SysCallN(14, 0, m.Instance())
	return api.GoStr(r)
}
...
func (m *TCEFFileDialogInfo) DefaultAllFileDesc() string {
	...
	r := cEFFileDialogInfoAPI().SysCallN(15, 0, m.Instance())
	return api.GoStr(r)
}
...
func (m *TCEFFileDialogInfo) DefaultUnknownFileDesc() string {
	...
	r := cEFFileDialogInfoAPI().SysCallN(16, 0, m.Instance())
	return api.GoStr(r)
}
