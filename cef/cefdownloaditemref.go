...
func (m *TCefDownloadItemRef) GetFullPath() string {
	if !m.IsValid() {
		return ""
	}
	r := cefDownloadItemRefAPI().SysCallN(13, m.Instance())
	return api.GoStr(r)
}
...
func (m *TCefDownloadItemRef) GetUrl() string {
	if !m.IsValid() {
		return ""
	}
	r := cefDownloadItemRefAPI().SysCallN(15, m.Instance())
	return api.GoStr(r)
}

func (m *TCefDownloadItemRef) GetOriginalUrl() string {
	if !m.IsValid() {
		return ""
	}
	r := cefDownloadItemRefAPI().SysCallN(16, m.Instance())
	return api.GoStr(r)
}

func (m *TCefDownloadItemRef) GetSuggestedFileName() string {
	if !m.IsValid() {
		return ""
	}
	r := cefDownloadItemRefAPI().SysCallN(17, m.Instance())
	return api.GoStr(r)
}

func (m *TCefDownloadItemRef) GetContentDisposition() string {
	if !m.IsValid() {
		return ""
	}
	r := cefDownloadItemRefAPI().SysCallN(18, m.Instance())
	return api.GoStr(r)
}

func (m *TCefDownloadItemRef) GetMimeType() string {
	if !m.IsValid() {
		return ""
	}
	r := cefDownloadItemRefAPI().SysCallN(19, m.Instance())
	return api.GoStr(r)
}
