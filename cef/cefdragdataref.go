...
func (m *TCefDragDataRef) GetLinkUrl() string {
	if !m.IsValid() {
		return ""
	}
	r := cefDragDataRefAPI().SysCallN(6, m.Instance())
	return api.GoStr(r)
}

func (m *TCefDragDataRef) GetLinkTitle() string {
	if !m.IsValid() {
		return ""
	}
	r := cefDragDataRefAPI().SysCallN(7, m.Instance())
	return api.GoStr(r)
}

func (m *TCefDragDataRef) GetLinkMetadata() string {
	if !m.IsValid() {
		return ""
	}
	r := cefDragDataRefAPI().SysCallN(8, m.Instance())
	return api.GoStr(r)
}

func (m *TCefDragDataRef) GetFragmentText() string {
	if !m.IsValid() {
		return ""
	}
	r := cefDragDataRefAPI().SysCallN(9, m.Instance())
	return api.GoStr(r)
}

func (m *TCefDragDataRef) GetFragmentHtml() string {
	if !m.IsValid() {
		return ""
	}
	r := cefDragDataRefAPI().SysCallN(10, m.Instance())
	return api.GoStr(r)
}

func (m *TCefDragDataRef) GetFragmentBaseUrl() string {
	if !m.IsValid() {
		return ""
	}
	r := cefDragDataRefAPI().SysCallN(11, m.Instance())
	return api.GoStr(r)
}

func (m *TCefDragDataRef) GetFileName() string {
	if !m.IsValid() {
		return ""
	}
	r := cefDragDataRefAPI().SysCallN(12, m.Instance())
	return api.GoStr(r)
}
